...
public class LeaderboardShowcase : MonoBehaviour {
    ...
    public void Load() {
        ...
        Leaderboards.BB_Leaderboard.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
    ...
    public void Submit() {
        _playerScore = ScoreManager.Instance.currentScore;
        Leaderboards.BB_Leaderboard.UploadNewEntry(_playerUsernameInput.text, _playerScore, Callback, ErrorCallback);
        
    }

    public void DeleteEntry() {
        Leaderboards.BB_Leaderboard.DeleteEntry(Callback, ErrorCallback);
    }
    ...
    /* public void GetPersonalEntry()
     {
         Leaderboards.BB_Tester_Leaderboard.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
     }*/
